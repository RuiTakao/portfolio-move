...
class ProductsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->maxLength('product_detail', 255)
            ->requirePresence('product_detail', 'create')
            ->notEmptyString('product_detail');

        $validator
            ->boolean('upload_or_url_path')
            ->requirePresence('upload_or_url_path', 'create')
            ->notEmptyString('upload_or_url_path');
        ...
        $validator
            ->scalar('movie_path')
            ->maxLength('movie_path', 255)
            ->allowEmptyString('movie_path');

        $validator
            ->boolean('product_view_flg')
            ->notEmptyString('product_view_flg');

        $validator
            ->integer('product_order')
            ->notEmptyString('product_order');
